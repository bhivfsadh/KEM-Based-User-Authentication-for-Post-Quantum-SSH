#!/usr/bin/env python3
# analyze.py — Figure 3 unified rerun summary
...
def main():
    ...
    # readable.md
    lines = []
    lines.append("# Figure 3 Unified Rerun (Generated)")
    lines.append("")
    ...
    lines.append("")
    lines.append("> Latency is measured from TCP SYN to successful user authentication. Only successful measure-phase samples are included.")
