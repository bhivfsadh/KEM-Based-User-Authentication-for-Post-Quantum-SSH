#!/usr/bin/env python3
# analyze_test4a.py — Exp 4 sub-experiment 1: RTT scan results
...
def analyze(raw_csv, summary_csv, output_md=None):
    ...
    # Markdown
    lines = [
        '# Exp 4 Sub-Experiment 1: Dense RTT Sensitivity',
        '',
...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        print("Usage: analyze_test4a.py <raw_csv> <summary_csv> [output_md]")
        sys.exit(1)
